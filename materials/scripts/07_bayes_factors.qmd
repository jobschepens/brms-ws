...
- **Evid.Ratio**: `r sprintf("%.2f", h_summary$Evid.Ratio)` means BF₀₁ = `r sprintf("%.2f", h_summary$Evid.Ratio)`, so BF₁₀ = 1/`r sprintf("%.2f", h_summary$Evid.Ratio)` = `r sprintf("%.0f", 1/h_summary$Evid.Ratio)`
- **Conclusion**: Data are **`r sprintf("%.0f", 1/h_summary$Evid.Ratio)` times more likely** under H₁ (effect exists) than H₀ (no effect)
