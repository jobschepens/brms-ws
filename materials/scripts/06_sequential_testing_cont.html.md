...
for (n in sample_sizes_cont) {
  ...
  rope_narrow <- rope(fit_narrow, range = c(-0.05, 0.05), ci = 0.95)$ROPE_Percentage
  rope_wide <- rope(fit_wide, range = c(-0.05, 0.05), ci = 0.95)$ROPE_Percentage
  ...
  gain_wide <- loo_wide$estimates["elpd_loo","Estimate"] - loo_null$estimates["elpd_loo","Estimate"]
  gain_narrow <- loo_narrow$estimates["elpd_loo","Estimate"] - loo_null$estimates["elpd_loo","Estimate"]
